...
- Enter or paste study material
- Select the number of questions
- Select the difficulty level
- Generate multiple-choice questions
- View four answer options
- Check the correct answers
- Read explanations for the answers

The application provides a simple and user-friendly interface using **Streamlit**.
...
| Hugging Face | AI-based question generation |
